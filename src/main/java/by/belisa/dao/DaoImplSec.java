...
public class DaoImplSec<T, PK extends Serializable> implements Dao<T, PK> {

	private static Logger log = Logger.getLogger(DaoImplSec.class);
	...
	public DaoImplSec(Class<T> type) {
		this.type = type;
